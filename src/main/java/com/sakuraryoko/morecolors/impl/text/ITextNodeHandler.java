...
public interface ITextNodeHandler extends ITextHandler
{
	TextNode toTextNode(@Nonnull String str);
	TextNode toTextNode(@Nonnull Component text);
	Component formatTextNode(@Nonnull TextNode node);
}
